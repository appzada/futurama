...
import 'package:futurama/app_pages/q5_page_widget.dart';
...
class Q4PageWidget extends StatefulWidget {
  final int score;
  final rightAnswer;
  final currentStep;
  const Q4PageWidget({Key key, this.score, this.rightAnswer, this.currentStep}) : super(key: key);

  @override
  _Q4PageWidgetState createState() =>
      _Q4PageWidgetState(score: this.score, rightAnswer: this.rightAnswer, currentStep: this.currentStep);
}

class _Q4PageWidgetState extends State<Q4PageWidget> with ChangeNotifier {
  ...
  _Q4PageWidgetState({this.score, this.rightAnswer, this.currentStep});
