...
import 'package:futurama/app_pages/results_page_widget.dart';
...
class Q5PageWidget extends StatefulWidget {
  final int score;
  final rightAnswer;
  final currentStep;
  const Q5PageWidget({Key key, this.score, this.rightAnswer, this.currentStep}) : super(key: key);

  @override
  _Q5PageWidgetState createState() =>
      _Q5PageWidgetState(score: this.score, rightAnswer: this.rightAnswer, currentStep: this.currentStep);
}

class _Q5PageWidgetState extends State<Q5PageWidget> with ChangeNotifier {
  ...
  _Q5PageWidgetState({this.score, this.rightAnswer, this.currentStep});
