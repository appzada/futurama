...
class Q3PageWidget extends StatefulWidget {
  final int score;
  final rightAnswer;
  final currentStep;
  const Q3PageWidget({Key key, this.score, this.rightAnswer, this.currentStep}) : super(key: key);

  @override
  _Q3PageWidgetState createState() =>
      _Q3PageWidgetState(score: this.score, rightAnswer: this.rightAnswer, currentStep: this.currentStep);
}

class _Q3PageWidgetState extends State<Q3PageWidget> with ChangeNotifier {
  ...
  _Q3PageWidgetState({this.score, this.rightAnswer, this.currentStep});
